...
public:
    ...
    void Check()
    {
        Stack new_stack;
        Stack new_stack2;
        Check(new_stack, new_stack2);
    }
    void Check(Stack new_stack,Stack new_stack2)
    {
        ...
        cout << endl;
        Check1(new_stack);
      //  new_stack = new_stack.sortStack(new_stack);
    }
    //------------------------------------------------------------------------------------
    // Printing all possible games collectively which a player can play within given time
    void Check1( Stack new_stack)
    {
        Stack new_stack1;
        Check1(new_stack,new_stack1);
    }
    void Check1( Stack new_stack, Stack new_stack1)
    {
        if(!new_stack.is_Empty())
        {
            temp = new_stack.Top();
            new_stack.pop();
            /*if(!new_stack1.is_Empty())
            {
                cout << "yesssss " << endl;
            ...
            if(!new_stack1.is_Empty())
            {
                ...
                new_stack1.pop();
                return Check1(new_stack,  new_stack1);
            }
    ...
    //------------------------------------------------------------------------------------
    // Printing all possible games collectively which a player can play within given time
    void Check2(Stack new_stack2)
    {
        int Tmp = 0, n =0;
        new_stack2 = new_stack2.sortStack(new_stack2);
        cout << " Stage number : ";
        Check2( new_stack2, Tmp, n );
    }
    Stack Check2(Stack new_stack2,int Tmp,int n )
    {
        if(!new_stack2.is_Empty())
        {
            ...
            new_stack2.pop();
            return Check2(new_stack2,Tmp,n);
        }
        else
            cout << "can only be played with points : " << n <<" ---->>IT IS THE BEST CHOICE "<< endl;
            return 0;
